  ...
  <div class="min-h-screen flex flex-col items-center relative overflow-hidden"
    ...
    <div class="bg-white/85 backdrop-blur-xl rounded-3xl p-8 w-11/12 max-w-md shadow-2xl border border-white/40 z-10"
      ...
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold mb-2" style="color: #1F2937;">Forgot Password?</h1>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-5">
        <div class="relative">
          <input type="email" placeholder="Email Address"
            ...
            }" v-model="identifier" :disabled="authStore.loading" inputmode="email" required />
        </div>
...
const handleSubmit = async () => {
  ...
  const body = { email: identifier.value, label: verificationLabel.value };
